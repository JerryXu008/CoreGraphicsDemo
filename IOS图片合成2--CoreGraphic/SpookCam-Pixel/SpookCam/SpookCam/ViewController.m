...
//    
//    CGImageRef ff=ghostImage.CGImage;
//   int width= CGImageGetWidth(ff);
//   int height= CGImageGetHeight(ff);
//    UIGraphicsBeginImageContext(CGSizeMake(width, height));
//    
//    CGContextRef context=UIGraphicsGetCurrentContext();
//   
////    CGAffineTransform flip = CGAffineTransformMakeScale(1.0, -1.0);
////    CGAffineTransform flipThenShift = CGAffineTransformTranslate(flip,0,-height);
////    CGContextConcatCTM(context, flipThenShift);
//    // [ghostImage drawInRect:(CGRect){0,0,width,height}];
//    CGContextTranslateCTM(context, 0, height);
//    
//    CGContextScaleCTM(context, 1.0, -1.0);
//    
//   
//   CGContextDrawImage(context, (CGRect){0,0,width,height}, ghostImage.CGImage);
//    UIImage *imagecopy=UIGraphicsGetImageFromCurrentImageContext();
//    self.mainImageView.image=imagecopy;
